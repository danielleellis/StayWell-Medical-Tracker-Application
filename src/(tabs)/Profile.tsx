...
const ProfileScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            ...
            try {
                const response = await axios.get(`${serverEndpoint}/users/${user.userID}`);
                ...
                Alert.alert('Network Error', 'An error occurred while fetching profile data.');
            }
        };
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.subText}>{profileData.firstName} {profileData.lastName}</Text>
